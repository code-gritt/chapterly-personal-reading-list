      ...
      <div className="container">
        ...
        <div className="mx-auto max-w-xl">
          <p className="mt-5 text-center text-xl text-white/70">
            Chapterly gives you a clean, simple interface to add books, organize
            your list, and track your reading progress. Manage credits, see
            completed titles, and stay motivated—all in one place.
          </p>
        </div>
        <motion.div
          style={{
